...
class ControlNode(Node):
    def __init__(self):
        ...
        self.velocity_publisher = self.create_publisher(TwistStamped, '/mavros/setpoint_velocity/cmd_velt', qos_profile)
        ...
        self.pid = PIDController(kp=0.5, ki=0.1, kd=0.05, max_integral=0.2, min_output=-0.5, max_output=0.5)
    ...
    def control_loop(self):
        ...
        velocity_command.twist.angular.z = 0  # Ensure no rotational movement
